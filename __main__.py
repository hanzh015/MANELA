...
def main():
    ...
    parser.add_argument('-d',default=False,help="whether to use default values",action="store_true")
    parser.add_argument('-c',default=False,help="continued training path")
    ...
    parser.add_argument('--negative',type=int,defualt=5,help="negative sampling number")
    parser.add_argument('--neglen',type=int,defualt=10**8,help="the maximum number used for negative sampling")
    ...
    parser.add_argument('-p',default=True,help="whether to use poisson process",action="store_true")
